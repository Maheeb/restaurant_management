        ...
        <div class="container">
            ...
            <div class="menu-bottom animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
                <div class="col-md-4 menu-bottom1">
                    <div class="btm-right">
                        <a href="events.html">
                            <img src="{{asset('frontend/images/me.jpg')}}" alt="" class="img-responsive">
                            <div class="captn">
                                <h4>Lorem</h4>
                                <p>$20.00</p>
                            </div>
                ...
                <div class="col-md-4 menu-bottom1">
                    <div class="btm-right">
                        <a href="events.html">
                            <img src="{{asset('frontend/images/me1.jpg')}}" alt="" class="img-responsive">
                            <div class="captn">
                                <h4>Lorem</h4>
                                <p>$20.00</p>
                            </div>
                ...
                <div class="col-md-4 menu-bottom1">
                    <div class="btm-right">
                        <a href="events.html">
                            <img src="{{asset('frontend/images/me2.jpg')}}" alt="" class="img-responsive">
                            <div class="captn">
                                <h4>Lorem</h4>
                                <p>$20.00</p>
                            </div>
            ...
            <div class="menu-bottom animated wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="500ms">
                <div class="col-md-4 menu-bottom1">
                    <div class="btm-right">
                        <a href="events.html">
                            <img src="{{asset('frontend/images/me3.jpg')}}" alt="" class="img-responsive">
                            <div class="captn">
                                <h4>Lorem</h4>
                                <p>$20.00</p>
                            </div>
                ...
                <div class="col-md-4 menu-bottom1">
                    <div class="btm-right">
                        <a href="events.html">
                            <img src="{{asset('frontend/images/me4.jpg')}}" alt="" class="img-responsive">
                            <div class="captn">
                                <h4>Lorem</h4>
                                <p>$20.00</p>
                            </div>
                ...
                <div class="col-md-4 menu-bottom1">
                    <div class="btm-right">
                        <a href="events.html">
                            <img src="{{asset('frontend/images/me5.jpg')}}" alt="" class="img-responsive">
                            <div class="captn">
                                <h4>Lorem</h4>
                                <p>$20.00</p>
                            </div>
            ...
            <div class="menu-bottom animated wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="500ms">
                <div class="col-md-4 menu-bottom1">
                    <div class="btm-right">
                        <a href="events.html">
                            <img src="{{asset('frontend/images/me6.jpg')}}" alt="" class="img-responsive">
                            <div class="captn">
                                <h4>Lorem</h4>
                                <p>$20.00</p>
                            </div>
                ...
                <div class="col-md-4 menu-bottom1">
                    <div class="btm-right">
                        <a href="events.html">
                            <img src="{{asset('frontend/images/me7.jpg')}}" alt="" class="img-responsive">
                            <div class="captn">
                                <h4>Lorem</h4>
                                <p>$20.00</p>
                            </div>
                ...
                <div class="col-md-4 menu-bottom1">
                    <div class="btm-right">
                        <a href="events.html">
                            <img src="{{asset('frontend/images/me8.jpg')}}" alt="" class="img-responsive">
                            <div class="captn">
                                <h4>Lorem</h4>
                                <p>$20.00</p>
                            </div>
